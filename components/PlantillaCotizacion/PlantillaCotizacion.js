...
const Plantilla = (data) => {
    ...
    const { aeronave } = cotizacion
    const valorTotal = cotizacion.items.reduce((actual, siguiente) => actual + siguiente.total, 0)
                ...
                <View style={styles.todo}>
                            ...
                            <View style={styles.titleContainer}>
                                ...
                                <View style={styles.detailsTitle}>
                                    <View style={styles.numeroCotizacion}>
                                        <Text>Número cotización</Text>
                                        <Text style={{ fontSize: "10px" }}>{cotizacion.id.substr(18, 24).toUpperCase()}</Text>
                                    </View>
                                    <View style={styles.padding}>
                                        <Text>Fecha cotización</Text>
                                        <Text>{cotizacion.fechaRecepcion}</Text>
                                    </View>
                                    <View style={styles.padding}>
                                        <Text>Fecha estimada entrega</Text>
                                        <Text>{cotizacion.fechaEntrega}</Text>
                                    </View>
                                </View>
                            </View>
                        </View>
                                ...
                                <View key={i}>
                                    <View style={styles.tableContent}>
                                        ...
                                        <View style={styles.valorValue} >
                                            <Text>${parseInt(cotizacion.items[i].precio).toLocaleString(undefined, { maximumFractionDigits: 0 })}</Text>
                                        </View>
                    ...
                    <View style={styles.footer}>
                        ...
                        <View style={styles.observacionesContainer}>
                            ...
                            <View>
                                <Text>{cotizacion.observaciones}</Text>
                            </View>
                        </View>
