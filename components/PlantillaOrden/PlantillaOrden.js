...
const Plantilla = (data) => {
    ...
    const { orden } = data
    const { cliente } = orden
    const { aeronave } = orden
    const valorTotal = orden.items.reduce((actual, siguiente) => actual + siguiente.total, 0)
                ...
                <View style={styles.todo}>
                            ...
                            <View style={styles.titleContainer}>
                                ...
                                <View style={styles.detailsTitle}>
                                    <View style={styles.numeroCotizacion}>
                                        ...
                                        <Text style={{ fontSize: "10px" }}>{orden.id.substr(18, 24).toUpperCase()}</Text>
                                    </View>
                                    <View style={styles.padding}>
                                        <Text>Fecha recepción</Text>
                                        <Text>{orden.fechaRecepcion}</Text>
                                    </View>
                                    <View style={styles.padding}>
                                        <Text>Fecha estimada entrega</Text>
                                        <Text>{orden.fechaEntrega}</Text>
                                    </View>
                                </View>
                            </View>
                        </View>
                                ...
                                <View key={i}>
                                    <View style={styles.tableContent}>
                                        ...
                                        <View style={styles.valorValue} >
                                            <Text>${parseInt(orden.items[i].precio).toLocaleString(undefined, { maximumFractionDigits: 0 })}</Text>
                                        </View>
                                        <View style={styles.totalValue}>
                                            <Text>${item.total.toLocaleString(undefined, { maximumFractionDigits: 0 })}</Text>
                                        </View>
                                    </View>
                        ...
                        <View style={styles.detailsPaymentContainer}>
                            ...
                            <View style={styles.paymentDetails}>
                                <View style={styles.paymentDetailsDiv}>
                                    <Text>Sub total</Text>
                                    <Text>${valorSinIVa.toLocaleString(undefined, { maximumFractionDigits: 0 })}</Text>
                                </View>
                                <View style={styles.paymentDetailsDiv}>
                                    <Text>IVA</Text>
                                    <Text>${iva.toLocaleString(undefined, { maximumFractionDigits: 0 })}</Text>
                                </View>
                                <View style={styles.grandTotal} className="grand_total">
                                    <Text>Total</Text>
                                    <Text>${valorTotal.toLocaleString(undefined, { maximumFractionDigits: 0 })}</Text>
                                </View>
                            </View>
                        </View>
                    </View>
                    <View style={styles.footer}>
                        ...
                        <View style={styles.signContainer}>
                            <View style={styles.firstSignContainer}>
                                <View style={styles.dotLine}></View>
                                <View style={styles.signHeader}>
                                    <Text>Firma Tarea Aeropintura</Text>
                                </View>
                                <View style={styles.informationContainer}>
                                    <Text style={styles.marginBottom}>Nombre:</Text>
                                    <Text>C.C.</Text>
                                </View>
                            </View>
                            <View style={styles.secondSignContainer}>
                                <View style={styles.dotLine}></View>
                                <View style={styles.signHeader}>
