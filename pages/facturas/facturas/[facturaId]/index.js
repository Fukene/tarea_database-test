...
function InvoiceDetails(props) {
    ...
    const { data } = props;
    const goBack = () => router.push('/facturas')
    ...
    const borrarFactura = async (invoiceId) => {
    ...
    const convertirAOrden = async (invoiceId) => {
        try {
    ...
    return <div className='main_container'>
        ...
        <div className='invoice_details-header'>
            ...
            <div className='details_btns'>
                <button className='edit_btn' onClick={() => router.push(`/facturas/edit/${data.id}`)}>Editar</button>
                ...
                <div className="delete_modal" ref={modalRef}>
                    <div className="modal">
                        ...
                        <div className="details_btns modal_btns">
                            ...
                            <button className="discard_btn" onClick={() => borrarFactura(data.id)} >Confirmar</button>
                        </div>
                    </div>
                </div>
                ...
                <GenerarPDF data={data} tipo='factura' />
            </div>
        </div>
...
export async function getStaticProps(context) {
    ...
    const { facturaId } = context.params
    ...
    const factura = await facturas.findOne({ _id: ObjectId(facturaId) })
