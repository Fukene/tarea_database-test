...
const AddNew = () => {
    ...
    const createInvoice = async () => {
        try {
            ...
            const res = await fetch('/api/add-new-invoice', {
                method: 'POST',
                headers: {
    ...
    return <div className="main_container">
        <div className="new_invoice">
            ...
            <div className="new_invoice-body">
                ...
                <FontAwesomeIcon onClick={() => router.push(`/facturas`)} className="back_btn" icon={icon({ name: 'arrow-left', style: 'solid' })} />
                    <h2>Nueva factura</h2>
                </div>
                ...
                <div className="new_invoice_btns">
                    <button className="discard_btn" onClick={() => router.push('/facturas')}>Descartar</button>
