...
const AddNew = () => {
    ...
    const addItem = () => {
        setItems([...items, { cantidad: 0, precio: 0, descripcion: "", total: 0 }])
    }
    ...
    const createInvoice = async () => {
        try {
            ...
            const res = await fetch('/api/add-new-quote', {
                method: 'POST',
                headers: {
        ...
        <div className="new_invoice">
            ...
            <div className="new_invoice-body">
                <div className="new_invoice-header">
                    <FontAwesomeIcon onClick={() => router.push(`/cotizaciones`)} className="back_btn" icon={icon({ name: 'arrow-left', style: 'solid' })} />
                ...
                <div className="customer_details">
                    ...
                    <div className="form_group inline_form_group-two">
                        <div>
                            <p>Teléfono</p>
                            <input type="number" name='telefonoCliente' value={clienteTelefonoActualizado} onChange={controlarCambio} ref={telefonoCliente} />
                        </div>
                ...
                <div className="invoice_items">
                    ...
                    {
                        items?.map((item, i) => (
                            <div className="row_form-group" key={i}>
                ...
                <div className="new_invoice_btns">
                    <button className="discard_btn" onClick={() => router.push('/cotizaciones')}>Descartar</button>
                    <button className="send_btn" onClick={() => createInvoice()}>Enviar y Guardar</button>
                </div>
            </div>
        </div>
    </div>
